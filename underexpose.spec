...
%{__mkdir_p} %{buildroot}%{_usr}/%{_lib}/systemd/system
%{__mkdir_p} %{buildroot}%{_mandir}/man8
%{__mkdir_p} %{buildroot}%{_sysconfdir}/%{name}
%{__mkdir_p} %{buildroot}%{_var}/log/%{name}
%{__install} %{name} %{buildroot}%{_bindir}
%{__install} systemd/privoxy@.service %{_usr}/%{_lib}/systemd/system
%{__install} systemd/squid@.service %{_usr}/%{_lib}/systemd/system
%{__install} systemd/tor@.service %{_usr}/%{_lib}/systemd/system
...
%defattr(-,root,root,-)
%{_bindir}/%{name}
%{_usr}/%{_lib}/systemd/system/privoxy@.service
%{_usr}/%{_lib}/systemd/system/squid@.service
%{_usr}/%{_lib}/systemd/system/tor@.service
%doc %{DocFiles}
%doc %{DocFormats} pod
